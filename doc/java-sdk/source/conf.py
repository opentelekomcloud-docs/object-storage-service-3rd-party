...
otcdocs_doc_link = '/object-storage-service-3rd-party/java-sdk/'
otcdocs_doc_title = 'Java SDK'
otcdocs_doc_type = 'java-sdk'
...
html_title = "Object Storage Service 3rd Party - Java SDK"
...
latex_documents = [
    ('index',
     'obs_3rd_party-java-sdk.tex',
    u'Object Storage Service 3rd Party - Java SDK',
